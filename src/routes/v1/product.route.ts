...
// @access Public
v1router.get("/products/:productId", validateJWT, asyncHandler(getProductById));


//desc Update a product
// @route PUT /api/v1/products/:productId
// @access Private
v1router.put("/products/:productId", validateJWT, upload.single("image"), requireRole("restaurant"), asyncHandler(updateProduct));


//desc Delete a product
// @route DELETE /api/v1/products/:productId
// @access Private
v1router.delete("/products/:productId", validateJWT, requireRole("restaurant"), asyncHandler(deleteProduct));
